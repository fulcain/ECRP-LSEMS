...
export default function CommunicationUpdateForm() {
  ...
  const bbCodeText = useMemo(
    () =>
      generateCommunicationUpdateForm({
        medicCredentials,
        selectedDivision,
        selectedRank,
        patientName,
  ...
  return (
    <>
      ...
      <BodyAndMainTitle
        title="Communication Update Form"
        description="Fill in patient info, contact details, select division and rank"
      >
        {/* Division Selector */}
          ...
          <div className="mt-4 flex flex-col gap-4 sm:flex-row">
            ...
            <Button
              onClick={() =>
                copyBBCodeAndOpen({
                  bbCodeText,
                  url: "https://gov.eclipse-rp.net/viewforum.php?f=2390",
                })
              }
              disabled={!bbCodeText}
