    ...
    <div className="md:hidden">
      <Sheet>
        <SheetTrigger asChild>
          <Button
            className="h-10 w-10 rounded-xl border-slate-700/80 bg-slate-950/90 p-0 text-white shadow-lg shadow-slate-950/30 hover:bg-slate-900"
        ...
        <SheetContent side="right" className="w-[290px] border-l border-slate-800 bg-slate-950 px-4 pb-6 text-white [&>button[data-radix-collection-item]]:hidden">
