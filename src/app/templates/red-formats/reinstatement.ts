...
// Minimum activity per tier for the reinstatement offer's terms list. The tier
// list is derived from this map so the picker and the offer can't drift apart.
export const OFFER_HOURS: Record<string, string> = {
  "EMT-P": "1 hour/ month",
  "EMTs": "2.5 hours/ week",
  "Supervisors": "5 hours/ week",
  "Command+": "10 hours/ week",
};

export const OFFER_TIERS = Object.keys(OFFER_HOURS);
...
[*]Do the minimum required hours per pay cycle (${OFFER_HOURS[context.offerTier ?? ""] ?? OFFER_HOURS.EMTs})
[/list] 
