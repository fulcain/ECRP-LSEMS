...
[b]Date of Application Acceptance:[/b] {APPLICATION_DATE}
[/divbox]
...
[color=transparent]spacer[/color]
[list=1]
[*][color=#800000][b]Three Pillars of Training[/b][/color]
Explain the Three Pillars in detail:
[list]
[*][b]Effort[/b] - Putting effort into the training session is essential. The motiviation behind the effort is equally important, EMRs can and will pick up on lack of effort or motiviation.
[*][b]Time[/b] - EMRs have ample time to undergo their training (4 weeks) - ensure that the EMR is given a chance to learn, to digest and to understand the material. If an EMR seems to be rushing through training, reminding them that they have ample time is quite beneficial. Rushing only harms the digestion of the information provided through training.
[*][b]Patience[/b] - As an FTO, getting frustrated by the EMR is something that should be avoided. The EMR is in their training phase, and thus they would be sensitive to any frustration if they pick up on it.
[/list]
[color=transparent]spacer[/color]
[color=transparent]spacer[/color]
...
[*]Student Profiles (for both regular & reinstatement profiles)
[*]Student Area
...
[/divbox]
[/spoiler]
[b]Paperwork Instructions:[/b]
[spoil]
[list=1]
[*]Fill out the following paperwork then post it as a reply.
...
/** The gov.eclipse-rp.net URL for new posting (forum 1161). */
export const GOV_FTO_CREATION_POST_URL =
  "https://gov.eclipse-rp.net/posting.php?mode=post&f=1161";
 ...
 * roster editor.
 */
export const GOV_FT_ROSTER_EDIT_URL =
  "https://gov.eclipse-rp.net/posting.php?mode=edit&p=126130";

export interface FtoCreationBBCodeValues {
  /** Application name, as it should appear in `[b]Name:[/b] …`. */
